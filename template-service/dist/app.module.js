...
const template_history_entity_1 = require("./template/entities/template-history.entity");
    ...
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forRoot({
                ...
                entities: [template_entity_1.Template, template_history_entity_1.TemplateHistory],
                synchronize: true,
                ssl: {
